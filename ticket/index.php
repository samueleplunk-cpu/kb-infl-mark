...
// Ottieni ticket
$tickets = get_user_tickets($user_id, $user_type, $status !== 'all' ? $status : null, 1000);
...
// Notifiche non lette (sistema ticket)
...
<head>
    ...
    <title>Ticket di Supporto - Influencer Marketplace</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet">
    <link href="<?php echo BASE_URL; ?>/ticket/assets/styles.css" rel="stylesheet">
    <style>
        .ticket-status {
            font-size: 0.8rem;
    ...
    <div class="container py-4">
        <div class="row mb-4">
            <div class="col">
                ...
                <p class="text-muted">Gestisci le tue richieste di assistenza</p>
            </div>
            <div class="col-auto">
        ...
        <?php if (!empty($unread_ticket_notifications)): ?>
        <div class="alert alert-info alert-dismissible fade show" role="alert">
            <h5><i class="bi bi-bell"></i> Hai <?php echo count($unread_ticket_notifications); ?> notifiche ticket non lette</h5>
            <ul class="mb-0">
                <?php foreach(array_slice($unread_ticket_notifications, 0, 3) as $notification): ?>
                    <li><?php echo htmlspecialchars($notification['message']); ?></li>
                <?php endforeach; ?>
            </ul>
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
            <a href="#" class="btn btn-sm btn-outline-info mt-2" onclick="markAllAsRead()">Segna tutte come lette</a>
        </div>
        <?php endif; ?>
